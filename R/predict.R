...
#' probability.
#'
#' @param test_input The path to the input data file or a dataframe/tibble.
...
#'
#'   # Do the same thing, but using a dataframe rather than file path
#'   #'   # Fit weights to dataframe with no biases
#'   df <- read.csv(df_file)
#'   fit_model <- optimize_weights(df)
#'   predict_probabilities(df, fit_model$weights)
#'

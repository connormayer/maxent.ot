...
# For i-th constraint
# TODO: Rewrite this without ggplot
# for (i in 6:10) {
#   print(
#     # Select appropriate data
#     ggplot2::ggplot(hu_500simul_wts, ggplot2::aes(x=hu_500simul_wts[[i]])) +
#       # Simulated idealized weights (histogram)
#       ggplot2::geom_histogram(bins=15,
#                  color="black", fill="gray") +
#       # Human weights (blue vertical dashed line)
#       ggplot2::geom_vline(ggplot2::aes(xintercept=human_wug_model$weights[i]),
#             color="blue", linetype="dashed", size=1) +
#       # Add plot title
#       ggplot2::ggtitle(colnames(hu_500simul_wts[i])) +
#       # Change axis title
#       ggplot2::xlab("weight")
#   )
# }

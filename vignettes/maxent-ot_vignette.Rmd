...
%%TODO: The trade-off between model fit \& bias
...
%%TODO: (Actually, this is a problem in the vignette, because it won't even knit to html when errors are produced. So I've set `eval=FALSE` for now.)

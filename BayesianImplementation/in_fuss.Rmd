...
library(brms)
setwd("G:/My Drive/MIT/Research/maxent.ot/BayesianImplementation")
...
is_constraint_hierarchical_by_subjects <- c(1,1)
is_constraint_hierarchical_by_items <- c(1,1)
...
p1 <- stan(file="MultinomialModel_HierarchicalItemsAndSubjects.stan", data=s, iter=4000, chains=4, seed=3, thin = 1, cores = 4,control = list(adapt_delta = 0.8, max_treedepth = 10))
